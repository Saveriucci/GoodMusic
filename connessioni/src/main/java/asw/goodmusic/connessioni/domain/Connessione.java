...
@Table(uniqueConstraints = {
		@UniqueConstraint(name = "UniqueUtenteSeguitoRuolo", columnNames = { "utente", "seguito", "ruolo" }) })
public class Connessione {
	...
	/*
	 * chi o cosa è seguito (un artista oppure uno che scrive recensioni oppure un
	 * genere musicale)
	 */
