...
public class RecensioniController {
	...
	@Autowired
	private RecensioneEventPublisherService recensioneEventPublisherService;
	...
	public RecensioneResponse createRecensione(@RequestBody CreateRecensioneRequest request) {
		...
		logger.info("REST CALL: createRecensione " + recensore + ", " + album + ", " + artista + ", " + genere + ", "
				+ testo + ", " + sunto);
		...
		logger.info("REST CALL: createRecensione " + recensore + ", " + album + ", " + artista + ", " + genere + ", "
				+ testo + ", " + sunto
				+ " --> " + response);
		recensioneEventPublisherService.publish(recensione);
		return response;
	}
	...
	/*
	 * Trova tutte le recensioni relative a un insieme di artisti (in formato
	 * breve).
	 */
	...
	/*
	 * Converte una recensione (in formato completo) in una risposta recensione
	 * (sempre in formato completo).
	 */
	...
	/*
	 * Converte una recensione (in formato completo) in una risposta recensione in
	 * formato breve.
	 */
	...
	/*
	 * Converte una collezione di recensioni (in formato completo) in una collezione
	 * di risposte recensione (in formato breve).
	 */
	private Collection<RecensioneBreveResponse> toRecensioniResponse(Collection<Recensione> recensioni) {
		Collection<RecensioneBreveResponse> response = recensioni
				.stream()
